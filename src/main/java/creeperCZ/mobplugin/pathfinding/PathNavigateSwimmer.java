...
import creeperCZ.mobplugin.util.RayTraceResult;
...
public class PathNavigateSwimmer extends PathNavigate {
    ...
    protected boolean isDirectPathBetweenPoints(Vector3 posVec31, Vector3 posVec32, int sizeX, int sizeY, int sizeZ) {
        RayTraceResult raytraceresult = Utils.rayTraceBlocks(this.level, posVec31, new Vector3(posVec32.x, posVec32.y + (double) this.theEntity.getHeight() * 0.5D, posVec32.z), false, true, false);
