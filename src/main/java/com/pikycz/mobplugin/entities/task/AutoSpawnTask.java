package com.pikycz.mobplugin.entities.task;
...
public class AutoSpawnTask extends TimerTask {
    ...
    private void prepareMaxSpawns() {
        ...
        FileLogger.debug(String.format(
                ...
                + "[mooshroom:%d] [mule:%d] [ocelot:%d] [pig:%d] [pigZombie:%d] [rabbit:%d] [silverfish:%d] [sheep:%d] [skeleton:%d] [snowGolem:%d] [spider:%d] [wolf:%d] [zombie:%d] "
