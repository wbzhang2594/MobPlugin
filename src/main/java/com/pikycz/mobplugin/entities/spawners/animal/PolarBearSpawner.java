 ...
 * @author PikyCZ
 */
public class PolarBearSpawner extends BaseSpawner {

    public PolarBearSpawner(AutoSpawnTask spawnTask, Config config) {
    ...
    public SpawnResult spawn(IPlayer iPlayer, Position pos, Level level) {
        ...
        if (biomeId != Biome.ICE_PLAINS) {
            ...
            this.spawnTask.createEntity(getEntityName(), pos.add(0, 2.5, 0));
        }
