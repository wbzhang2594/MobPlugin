...
import com.pikycz.mobplugin.entities.monster.walking.LavaSlime;
 ...
 * @author PikyCZ
 */
public class LavaSlimeSpawner extends AbstractEntitySpawner {

    public LavaSlimeSpawner(AutoSpawnTask spawnTask, Config pluginConfig) {
